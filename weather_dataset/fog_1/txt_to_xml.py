...
if __name__ == '__main__':
    class_ind = ('van', 'person', 'car', 'truck')  # 修改为了4类
    cur_dir = os.getcwd()
    ...
    for parent, dirnames, filenames in os.walk(labels_dir):  # 分别得到根目录，子目录和根目录下文件
        for file_name in filenames:
            ...
            # print name
            img_name = name + '.jpg'
            img_path = os.path.join('E:/audodrive_project/Faster-RCNN-TensorFlow-Python3-master/data/VOCDevkit2007/VOC2007/JPEGImages',
                                    img_name)  # 路径需要自行修改
            # print img_path
